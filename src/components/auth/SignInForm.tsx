  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mb-4">Sign Up to create Account</h1>
      </div>
      ...
      <div className="mt-6 text-center">
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full flex items-center space-x-2 py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
            onClick={() => {
          ...
          >
            <svg
              className="w-5 h-5 text-[#1877F2] ml-5"
